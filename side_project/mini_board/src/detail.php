...
<body>
    ...
    <main>
            ...
            <div class="main_bottom">
                <a href="./update.php?no=<?php echo $no ?>&page=<?php echo $page?>" class="a_button small_button">수정</a>
                <a href="./list.php?page=<?php echo $page?>" class="a_button small_button">취소</a>
                <a href="./delete.php?no=<?php echo $no ?>&page=<?php echo $page?>" class="a_button small_button">삭제</a>
            </div>
    </main>
</body>
</html>