...
try {
    ...
    $result = db_select_boards_completed($conn, $arr_param);
    ...
    <div class="test">
        ...
        <main>
            ...
            <div class="main_nav_list">
                ...
                <div class="nav_list_box">
                    <a href="./list_com.php" class="list_text a_com now_page" >completed</a>
                </div>
                <div class="nav_list_box">
                    <a href="./list_uncom.php" class="list_text a_uncom">uncompleted</a>
                </div>
            </div>
            <div class="item_list">
                <?php
                    foreach($result as $item) {
                        ?>
                    <div class="item">
                        <div class="item_title"><a href="./detail_com.php?board_no=<?php echo $item["board_no"] ?>&page=<?php echo $page_num ?>"><?php echo $item["title"] ?></a></div>
